...
Here we will walk through your statistical modelling framework and discuss how to communicate motivations, methods and results of your data analysis and hypothesis testing for a biological report^[e.g. for a course] or article^[for publication!].
...
Your [response](DSPPH_SM_Responses.qmd) variable is the observed variability you are trying to explain.  Your response forms your **research question** - i.e. "why is my response varying?". In this section, you need to identify the variability you are trying to explain and why (your motivation).  
...
In this section you will describe your research [hypothesis](DSPPH_SM_Hypothesis.qmd), first in human language, and then as an R model formula.  Remember to communicate whether you will be including interactions along with main effects if you have more than one predictor. 
...
## STARTING MODEL
#### The task:
This step involves describing how you [built the statistical model](DSPPH_SM_StartingModel.qmd) to test your hypothesis.  Here, you will:
...
## HYPOTHESIS TESTING
#### The task:
Here, you will use your model to [test your hypothesis](DSPPH_SM_HypothesisTesting.qmd).  We will use here the model selection method to test the hypothesis.  You can also read about the role of p-values for testing your hypothesis [here](https://neuheimerlab.github.io/DSPPHandbook/DSPPH_SM_HypothesisTesting.html#sec_PValue).  
...
In this section, you will [report your hypothesis testing results](DSPPH_SM_Reporting.qmd). Specifically,
...
This interaction between the effects of latitude and sex on growth is also illustrated in our modelled response predictions: Growth rate of males at 61˚N is 23.0 kg year<sup>-1</sup> (95% confidence interval: 21.8 - 24.1 kg year<sup>-1</sup>) and increases to 25.6 kg year<sup>-1</sup> (95% confidence interval: 24.3 - 26.8 kg year<sup>-1</sup>) at 63˚N. Growth rate of females at 61˚N is 11.4 kg year<sup>-1</sup> (95% confidence interval: 10.2 - 12.5 kg year<sup>-1</sup>) and increases to 12.8 kg year<sup>-1</sup> (95% confidence interval: 11.5 - 14.0 kg year<sup>-1</sup>) at 63˚N.
...
## PREDICTING
#### The task:
Here you *may* use your model to make [predictions](DSPPH_SM_Predicting.qmd) (remembering prediction limits).  
...
<img src="./CommPaper_Overview.png" width="800px"/>

## Introduction
<img src="./CommPaper_Intro.png" width="800px"/>

## Methods
<img src="./CommPaper_Methods.png" width="800px"/>

## Results
<img src="./CommPaper_Results.png" width="800px"/>

## Discussion
<img src="./CommPaper_Discussion.png" width="800px"/>
