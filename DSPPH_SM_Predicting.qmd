...
forPred$Lower<-ilink(myPred$fit - 2*myPred$se.fit) # add your uncertainty to the data frame, 95% confidence intervals
forPred$Upper<-ilink(myPred$fit + 2*myPred$se.fit) # add your uncertainty to the data frame, 95% confidence intervals
