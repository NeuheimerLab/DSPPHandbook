...
All science is explaining variability - explaining why observations are changing in time and/or space. These explanations^[here, we can also use the term "research hypothesis" instead of explanation and you'll see we quickly switch to using this term] lead us to mechanistic understandings of why the world is as we observe it.
...
Statistics provides the mathematical tools^[Math skills have often been underemphasized in many Biology educations. This has not been helpful or necessary. Biologists need math and are very capable at applying math to solve problems, but the math needs to be useful; that is, math that you can apply to your own needs as you research biology. The DSP Program aims at providing statistical modelling tools that will be useful to you as a biologist. It is a happy coincidence that the same skills can be applied to a lot of other situations as well. The programming and statistics skills you are learning here will be useful to you in the future - in your future courses, thesis-writing and a wide range of careers.] to accomplish these tasks. It allows you to use a data sample to test your hypothesis about a population or system. Statistics help you determine the evidence for causal^[more on causal vs. correlative explanations coming soon] mechanisms. And statistics help you make useful predictions^[useful predictions will always include uncertainty] about how a biological system might behave at a different time or location.
