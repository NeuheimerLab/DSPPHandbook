...
Statistics provides the mathematical tools[^handbooksmintro-2] to accomplish these tasks. It allows you to use a data sample to test your hypothesis about a population or system. Statistics help you determine the evidence for causal[^handbooksmintro-3] mechanisms. And statistics help you make useful predictions[^handbooksmintro-4] about how a biological system might behave at a different time or location.
